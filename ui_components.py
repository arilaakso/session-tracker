...
from config import (FONT_SIZE, LISTBOX_HEIGHT, SUMMARY_HEIGHT)
...
def create_listbox(parent, fixed_font):
    ...
    listbox = tk.Listbox(listbox_frame, height=LISTBOX_HEIGHT, bg='#333333', fg='white', selectbackground='#555555', font=fixed_font)
...
def create_summary_text(parent, fixed_font):
    ...
    summary_text = tk.Text(summary_text_frame, height=SUMMARY_HEIGHT, bg='#333333', fg='white', font=fixed_font)
